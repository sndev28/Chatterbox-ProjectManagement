                        ...
                        child: Column(
                          ...
                          children: [
                                    ...
                                    Container(
                                      ...
                                      child: ListView.builder(
                                        ...
                                        itemBuilder: (context, index) {
                                          bool exists = false;
                                          bool existInProject = false;
                                          List usernames = [
                                            for (var user
                                                in currentChatMembersList)
                                              user.username
                                          ];
                                          List projectUsernames = [
                                            for (var user
                            ...
                            Padding(
                              ...
                              child: ListView.builder(
                                  itemCount: currentChatMembersList.length,
                                  primary: false,
                                  shrinkWrap: true,
                                  itemBuilder: (context, index) =>
                                      _cardGenerator(
                                          currentChatMembersList[index])),
                            ),
                          ],
                        ),
                      ),
